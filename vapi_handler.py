...
IMPORTANT: Be conversational and helpful. Let them talk about weather, road conditions, or any concerns they have. This should feel like talking to a real dispatcher."""
    ...
    # Use Twilio phone number ID for international calls (Indian numbers)
    if formatted_phone.startswith('+91'):
        # Use your Twilio phone number ID from Vapi dashboard for international calls
        payload["phoneNumberId"] = "5a59919f-b236-4e3e-af19-d61fb1791e8c"
        print(f"📞 Using Twilio phone number ID for Indian number: {formatted_phone}")
